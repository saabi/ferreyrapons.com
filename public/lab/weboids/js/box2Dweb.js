...
(function (a2j, window)
  ...
  a2j.is = function is(o1, o2)
    ...
    return (o1.constructor.implements != undefined) && (o1.constructor.implements[o2]);
    };
...
(function ()
  ...
  b2BroadPhase.prototype.TestOverlap = function (proxyA, proxyB)
    ...
    return !(proxyB_.lowerBounds[1] > proxyA_.upperBounds[1]);
    };
  ...
  b2ContactID.prototype.getKey = function()
    {
    return this._key;
    };
  b2ContactID.prototype.setKey = function (value)
    {
    if (value === undefined) value = 0;
    this._key = value;
    this.features._referenceEdge = this._key & 0x000000ff;
...
/*  Features.prototype.__defineGetter__('referenceEdge', function ()
  ...
  Features.prototype.getReferenceEdge = function ()
    {
    return this._referenceEdge;
    };
  Features.prototype.setReferenceEdge = function (value)
    {
    if (value === undefined) value = 0;
    this._referenceEdge = value;
    this._m_id._key = (this._m_id._key & 0xffffff00) | (this._referenceEdge & 0x000000ff);
    };
  Features.prototype.getIncidentEdge = function ()
    {
    return this._incidentEdge;
    };
  Features.prototype.setIncidentEdge = function (value)
    {
    if (value === undefined) value = 0;
    this._incidentEdge = value;
    this._m_id._key = (this._m_id._key & 0xffff00ff) | ((this._incidentEdge << 8) & 0x0000ff00);
    };
  Features.prototype.getIncidentVertex = function ()
    {
    return this._incidentVertex;
    };
  Features.prototype.setIncidentVertex = function (value)
    {
    if (value === undefined) value = 0;
    this._incidentVertex = value;
    this._m_id._key = (this._m_id._key & 0xff00ffff) | ((this._incidentVertex << 16) & 0x00ff0000);
    };
  Features.prototype.getFlip = function ()
    {
    return this._flip;
    };
  Features.prototype.setFlip = function (value)
    {
    if (value === undefined) value = 0;
    this._flip = value;
    this._m_id._key = (this._m_id._key & 0x00ffffff) | ((this._flip << 24) & 0xff000000);
...
(function ()
  ...
  b2Color.prototype.setR = function (rr)
    {
    if (rr === undefined) rr = 0;
    this._r = a2j.parseUInt(255 * b2Math.Clamp(rr, 0.0, 1.0));
    };
  b2Color.prototype.setG = function (gg)
    {
    if (gg === undefined) gg = 0;
    this._g = a2j.parseUInt(255 * b2Math.Clamp(gg, 0.0, 1.0));
    };
  b2Color.prototype.setB = function (bb)
    {
    if (bb === undefined) bb = 0;
    this._b = a2j.parseUInt(255 * b2Math.Clamp(bb, 0.0, 1.0));
    };
  b2Color.prototype.getColor = function ()
    {
...
(function ()
  ...
  b2Math.prototype.MulTMV = function (A, v)
    {
    return new b2Vec2(this.Dot(a2j.generateCallback(this, v), A.col1), this.Dot(a2j.generateCallback(this, v), A.col2));
    };
  ...
  b2Math.prototype.AddMM = function (A, B)
    {
    return b2Mat22.FromVV(this.AddVV(a2j.generateCallback(this, A.col1), B.col1), this.AddVV(a2j.generateCallback(this, A.col2), B.col2));
    };
  b2Math.AddMM = b2Math.prototype.AddMM;
  b2Math.prototype.MulMM = function (A, B)
    {
    return b2Mat22.FromVV(this.MulMV(a2j.generateCallback(this, A), B.col1), this.MulMV(a2j.generateCallback(this, A), B.col2));
    };
  ...
  b2Math.prototype.AbsV = function (a)
    {
    return new b2Vec2(this.Abs(a2j.generateCallback(this, a.x)), this.Abs(a2j.generateCallback(this, a.y)));
    };
  b2Math.AbsV = b2Math.prototype.AbsV;
  b2Math.prototype.AbsM = function (A)
    {
    return b2Mat22.FromVV(this.AbsV(a2j.generateCallback(this, A.col1)), this.AbsV(a2j.generateCallback(this, A.col2)));
    };
  ...
  b2Math.prototype.MinV = function (a, b)
    {
    return new b2Vec2(this.Min(a2j.generateCallback(this, a.x), b.x), this.Min(a2j.generateCallback(this, a.y), b.y));
    };
  ...
  b2Math.prototype.MaxV = function (a, b)
    {
    return new b2Vec2(this.Max(a2j.generateCallback(this, a.x), b.x), this.Max(a2j.generateCallback(this, a.y), b.y));
    };
...
/*  b2Vec2.prototype.__defineSetter__('y', function(value)
    {
    if (window['game'])
      if (game.playerShip)
        if (game.playerShip.m_xf.position === this)
          if (value !== this.__y)
            debugger;
    this.__y = value;
    });
  b2Vec2.prototype.__defineGetter__('y', function() { return this.__y; });*/
...
(function ()
  ...
  b2Body.prototype.Merge = function (other)
    ...
    var body1 = this;
    var center1 = body1.GetWorldCenter();
    var center2 = other.GetWorldCenter();
    var velocity1 = body1.GetLinearVelocity().Copy();
    var velocity2 = other.GetLinearVelocity().Copy();
    var angular1 = body1.GetAngularVelocity();
    var angular = other.GetAngularVelocity();
    body1.ResetMassData();
  ...
  b2Body.prototype.SetMassData = function (massData)
    {
    b2Settings.b2Assert(!this.m_world.IsLocked());
    if (this.m_world.IsLocked())
      {
      return;
      }
    ...
    for (; ;)
      ...
      for (c = this.m_contactList;
        ...
        if (c.m_flags & b2Contact.e_toiFlag)
          ...
          bA = fA.m_body;
          bB = fB.m_body;
          if ((bA.GetType() != b2Body.b2_dynamicBody || !bA.IsAwake()) && (bB.GetType() != b2Body.b2_dynamicBody || !bB.IsAwake()))
            {
            continue;
            }
...
//post-definitions
for (i = 0; i < _A2J_postDefs.length; ++i) _A2J_postDefs[i]();