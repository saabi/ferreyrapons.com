...
export class WebGLSupport {
    constructor() {
        ...
        for (let y=0; y<lettersPerSide; y++) {
        ...
        for (i=0; i<str.length; i++) {
            ...
            let cx = code % lettersPerSide;
            let cy = Math.floor(code / lettersPerSide);
            //let t;
            geo.vertices.push(
            ...
            let face = new THREE.Face3(i*4, i*4+1, i*4+2);
            geo.faces.push(face);
            face = new THREE.Face3(i*4, i*4+2, i*4+3);
            geo.faces.push(face);
            let ox=(cx+0.05)/lettersPerSide, oy=(cy+0.05)/lettersPerSide, off=0.9/lettersPerSide;
            //let sz = lettersPerSide*fontSize;
            geo.faceVertexUvs[0].push([
